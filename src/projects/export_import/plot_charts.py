...
plt.xticks(rotation=30, ha='right')
plt.tight_layout()
chart2_path = "output/chart/export_price_by_component.png"
...
plt.xticks(rotation=30, ha='right')
plt.tight_layout()
chart3_path = "output/chart/import_price_by_component.png"
...
chart4_path = "output/chart/export_weights_structure.png"
...
chart5_path = "output/chart/import_weights_structure.png"
...
chart6_path = "output/chart/export_contribution_to_growth.png"
...
chart7_path = "output/chart/import_contribution_to_growth.png"
...
plt.tight_layout()
chart8_path = "output/chart/export_subcomponent_weights.png"
...
plt.tight_layout()
chart9_path = "output/chart/import_subcomponent_weights.png"
