...
def main():
    ...
    try:
        add_dataset(
            ...
            transformed_path="output/data/energy_price_forecast/dubai_oil_us_crude_production.csv",
            status="Ready"
        )
    ...
    # Save figure
    out_chart_path = "output/chart/energy_price_forecast/dubai_oil_us_crude_production.png"
    ...
    try:
        add_visualization(
            ...
            source_data="output/data/energy_price_forecast/dubai_oil_us_crude_production.csv",
