...
def main():
    ...
    tbl_path = project_root / "output" / "data" / "energy_price_forecast" / "dubai_situation_2026.csv"
    ...
    # Save figure
    out_chart_path = "output/chart/energy_price_forecast/dubai_oil_situation.png"
