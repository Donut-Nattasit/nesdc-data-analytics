...
def plot_cpi_series(df, columns, title, filename, output_dir, colors=None, start_date="2021-01-01"):
    ...
    # Format X axis for long-range plotting
...
def main():
    print("==========================================================")
    print("[LR Visualization] Generating forecast line charts (LR)...")
    print("==========================================================")
    
    project_root = Path(__file__).resolve().parent.parent.parent.parent
    data_path = project_root / "output" / "data" / "energy_price_forecast_LR" / "cpi_forecast_monthly.csv"
    chart_out_dir = project_root / "output" / "chart" / "energy_price_forecast_LR"
    ...
    plot_cpi_series(
        ...
        title="Thailand Consumer Price Index (CPI): Composites Forecast (LR)",
    ...
    plot_cpi_series(
        ...
        title="CPI Components: Core CPI Items Forecast (LR)",
    ...
    plot_cpi_series(
        ...
        title="CPI Components: Non-Core (Raw Food & Energy) Items Forecast (LR)",
