...
def main():
    ...
    forecast_path = "output/data/ex_im_price_forecast/export_import_price_forecast_baseline.csv"
    ...
    plt.tight_layout()
    chart_path = "output/chart/ex_im_price_forecast/export_import_price_forecast_baseline.png"
    plt.savefig(chart_path, dpi=300, bbox_inches='tight')
    plt.close()
    print(f"Saved forecast baseline visualization to {chart_path}")
    
    # ------------------ Write Model Summary ------------------
    summary_path = "output/model_summary/ex_im_price_forecast/export_import_price_forecast_baseline_summary.txt"
