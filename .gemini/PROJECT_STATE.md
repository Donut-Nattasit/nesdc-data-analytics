...
| WTIPUUS, BREPUUS | EIA STEO | output/data/eia_crude_oil_prices.csv | | | Ready | 2026-05-13 |
...
| :--- | :--- | :--- | :--- | :--- |
| TH Public Debt ARIMA | Auto-ARIMA | output/data/ceic_th_public_debt_gdp.csv | output/model/th_public_debt_gdp_arima_summary.txt | Finalized |
| US Inflation ARDL | ARDL | output/data/us_inflation_m2_ardl_data.csv | output/model/us_inflation_m2_ardl_summary.txt | Finalized |
| US Macro VAR | VAR | output/data/us_macro_var_transformed.csv | output/model/us_macro_var_summary.txt | Finalized |
| US Macro Causality | Granger | output/data/us_macro_var_transformed.csv | output/model/us_macro_var_causality.txt | Finalized |
| US Real GDP ARIMA | Auto-ARIMA | output/data/us_real_gdp_historical.csv | output/model/us_real_gdp_arima_summary.txt | Finalized |
