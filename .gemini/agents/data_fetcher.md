...
* **CSV Export Question**: You must also ask: *"I will save this to our unified SQLite database (`output/data/time_series.db`). Do you also need a .csv copy exported for Excel viewing?"*
